 ...
 */
@Named(value = "bean_Mantenimiento_Facturacion")
@SessionScoped
public class Bean_Mantenimiento_Facturacion implements Serializable {
    ...
    /**
     * Creates a new instance of Bean_Mantenimiento_Facturacion
     */
    public Bean_Mantenimiento_Facturacion() throws SNMPExceptions, SQLException {
        this.llenaLista();
    }
    ...
    public void llenaLista() throws SNMPExceptions, SQLException {
        ...
        this.setListaTransacciones((LinkedList<Transaccion>) this.log.obtieneLista_Mantenimiento_Facturacion());
    }
    ...
    public void facturarPedido() throws SNMPExceptions, SQLException, NamingException, ClassNotFoundException {
        if (this.transaccionSeleccionada != null) {
            ...
            this.log.apruebaPedido_Facturacion(transaccionSeleccionada);
            this.llenaLista();
